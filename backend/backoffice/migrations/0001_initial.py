    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spectator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backoffice.spectator', verbose_name='Client')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buying_key', models.CharField(max_length=250, unique=True, verbose_name="Clé d'achat")),
        ...
        migrations.CreateModel(
            name='User',
            fields=[
                ('spectator_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='backoffice.spectator')),
                ...
                ('auth_key', models.UUIDField(default=uuid.uuid4, editable=False, verbose_name="Clé d'authentification")),
            ...
            bases=('backoffice.spectator', models.Model),
            managers=[
